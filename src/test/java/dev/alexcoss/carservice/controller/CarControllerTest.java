...
class CarControllerTest {
    ...
    public void testCreateCar() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/cars")
            ...
            .andExpect(header().string("Location", "/api/v1/cars?manufacturer=Audi&model=Q3&minYear=2020"))
    ...
    void testListCars() throws Exception {
        ...
        when(carService.getListCarsWithPagination(any(), any(), any(), any(), any(), any(Pageable.class))).thenReturn(page);
